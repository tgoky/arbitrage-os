// src/components/PricingCalculatorLoadingOverlay.tsx
...
const pricingCalculatorLoadingTips = [
...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible }) => {
  const [currentTip, setCurrentTip] = useState(pricingCalculatorLoadingTips[0]);
  ...
  useEffect(() => {
    ...
    const tipInterval = setInterval(() => {
      setCurrentTip(pricingCalculatorLoadingTips[Math.floor(Math.random() * pricingCalculatorLoadingTips.length)]);
    }, 2000);
