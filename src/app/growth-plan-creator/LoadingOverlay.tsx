...
const offerCreatorLoadingTips = [
 'Analyzing industry trends...',
  ...
  'Strategizing the right roadmaps'
];
...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible, onComplete, onClose }) => {
  ...
  const fileManagerFiles = [
    { name: 'growth_draft.docx', icon: <FileTextOutlined />, size: '2.4MB', type: 'document' },
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Text strong style={{ fontSize: 12 }}>Generating Growth Plan</Text>
            </div>
            <div style={{ display: 'flex', gap: 2 }}>
              <Button 
                style={{ 
      ...
      >
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <Text strong style={{ fontSize: 14, color: '#fff' }}>Generating Growth Plan</Text>
          </div>
          <div style={{ display: 'flex', gap: 2 }}>
            <Button 
              style={{ 
        ...
        {!isMaximized && (
          <div style={{ 
            ...
            <Text type="secondary" style={{ fontSize: 10, color: '#000' }}>
              You can continue using the app while we generate your growth plan
            </Text>
          </div>
        )}
      </div>
