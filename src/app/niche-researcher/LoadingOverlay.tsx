...
const offerCreatorLoadingTips = [
  ...
  'Finding gaps and arbitrage opportunities'
];
...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible, onComplete, onClose }) => {
  ...
  const loadingSteps = [
    ...
    { id: 'pricing', name: 'Recommending niche', duration: 1600 },
    { id: 'assets', name: 'Generating assets', duration: 2000 },
    { id: 'export', name: 'Preparing export', duration: 2400 },
    { id: 'final', name: 'Finding your niches', duration: 2800 },
  ];
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Text strong style={{ fontSize: 12 }}>Generating Niche Research Report</Text>
            </div>
            <div style={{ display: 'flex', gap: 2 }}>
              <Button 
                style={{ 
      ...
      >
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <Text strong style={{ fontSize: 14, color: '#fff' }}>Generating Niche Research Report</Text>
          </div>
          <div style={{ display: 'flex', gap: 2 }}>
            <Button 
              style={{ 
