...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible, onComplete, onClose }) => {
  ...
  const loadingSteps = [
    ...
    { id: 'pricing', name: 'Constructing ads', duration: 1600 },
    { id: 'assets', name: 'Generating assets', duration: 2000 },
    { id: 'export', name: 'Preparing export', duration: 2400 },
    { id: 'final', name: 'Finalizing ads', duration: 2800 },
  ];

  const fileManagerFiles = [
    { name: 'ad_draft.docx', icon: <FileTextOutlined />, size: '2.4MB', type: 'document' },
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Text strong style={{ fontSize: 12 }}>Generating Ad</Text>
            </div>
            <div style={{ display: 'flex', gap: 2 }}>
              <Button 
                style={{ 
      ...
      >
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <Text strong style={{ fontSize: 14, color: '#fff' }}>Generating Ad</Text>
          </div>
          <div style={{ display: 'flex', gap: 2 }}>
            <Button 
              style={{ 
        ...
        {!isMaximized && (
          <div style={{ 
            ...
            <Text type="secondary" style={{ fontSize: 10, color: '#000' }}>
              You can continue using the app while we generate your ad
            </Text>
          </div>
        )}
      </div>
