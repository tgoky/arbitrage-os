...
const offerCreatorLoadingTips = [
  ...
  'Evaluating objection handling techniques...',
  'Extracting action items and next steps...',
  'Calculating talk time ratios...',
...
const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible, onComplete, onClose }) => {
  ...
  const loadingSteps = [
    ...
    { id: 'pricing', name: 'Reading the room', duration: 1600 },
    { id: 'assets', name: 'Analyzing calls', duration: 2000 },
    { id: 'export', name: 'Preparing export', duration: 2400 },
    { id: 'final', name: 'Finalizing transcript', duration: 2800 },
  ];

  const fileManagerFiles = [
    { name: 'niche_draft.docx', icon: <FileTextOutlined />, size: '2.4MB', type: 'document' },
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Text strong style={{ fontSize: 12 }}>Analyzing Call Transcript</Text>
            </div>
            <div style={{ display: 'flex', gap: 2 }}>
              <Button 
                style={{ 
      ...
      >
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <Text strong style={{ fontSize: 14, color: '#fff' }}>Analyzing Call Transcript</Text>
          </div>
          <div style={{ display: 'flex', gap: 2 }}>
            <Button 
              style={{ 
        ...
        {!isMaximized && (
          <div style={{ 
            ...
            <Text type="secondary" style={{ fontSize: 10, color: '#000' }}>
              You can continue using the app while we generate your niche report
            </Text>
          </div>
        )}
      </div>
